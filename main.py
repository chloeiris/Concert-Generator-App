...
with plot:
    ...
    axes.boxplot(x=df_filter['val'], widths=0.25, positions=[0.5], patch_artist= True, notch=True, labels=["mood"],
    ...
    axes.boxplot(x=df_filter['dnce'], widths=0.25, positions=[1], patch_artist= True, notch=True, labels=["danceability"], 
    ...
    axes.boxplot(x=df_filter['nrgy'], widths=0.25, positions=[1.5], patch_artist= True, notch=True, labels=["popularity"], 
    ...
    axes.boxplot(x=df_filter['nrgy'], widths=0.25, positions=[2], patch_artist= True, notch=True, labels=["energy"], 
